...
class MapGenerator:
    ...
    def _add_vessel_marker(self, m: folium.Map, vessel: Vessel):
        """
        Add a single vessel marker to the map.
        ...
        <div style="font-family: Arial; min-width: 180px;">
            ...
            <table style="font-size: 11px;">
                ...
                <tr><td><b>Speed:</b></td><td>{vessel.speed or 'N/A'} kts</td></tr>
                <tr><td><b>Course:</b></td><td>{vessel.course or 'N/A'}°</td></tr>
                <tr><td><b>To:</b></td><td>{vessel.destination or 'Unknown'}</td></tr>
                <tr><td><b>Position:</b></td><td>{vessel.lat:.3f}, {vessel.lon:.3f}</td></tr>
                <tr><td><b>Updated:</b></td><td>{vessel.last_update or 'N/A'}</td></tr>
            </table>
        </div>
        """
        ...
        folium.CircleMarker(
            ...
            tooltip=f"{vessel.name or vessel.mmsi} - {vessel.speed or 0} kts",
            color=color,
            fill=True,
            fillColor=color,
            fillOpacity=0.9
    ...
    def generate_map(self, vessels: Dict[int, Vessel], auto_open: bool = False):
        ...
        logger.info(f"\n🗺️  Generating map with {active_count} vessels...")
